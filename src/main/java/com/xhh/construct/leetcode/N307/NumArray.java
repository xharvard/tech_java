package com.xhh.construct.leetcode.N307;
...
public class NumArray {
    ...
    private class SegmentTree<E> {
        ...
        private void set(int treeIndex, int start, int end, int index, E e) {
            if (start == end) {
                tree[treeIndex] = e;
                return;
            }
            ...
            if (index >= mid + 1)
                ...
                set(leftIndex, start, mid, index, e);
         ...
         * @param start 值的开始区间
         * @param end 值的结束区间
         * @param queryL 查询的开始区间
         * @param queryR 查询的结束区间
         * @return
         */
